...
app.get('/players', (req, res, next) => {
    res.render('players', { players }) //Pass the player array to the render inside of an object (key and value is the same)
})

app.get('/teams', (req, res, next) => {
    res.render('teams', { layout: false }) //Makes the layout not show on teams' view
})
...
//Layout (always shows up with the view you're rendering in it)